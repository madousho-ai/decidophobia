...
两种布局:
  menu-first     指令 + 菜单 + 用户句 + Answer:   —— 答案位置读用户句时已经知道选项
...
LAYOUTS = ("menu-first", "context-first")
...
def split_prompt(ex: MenuExample, names: dict[int, str], layout: str = "menu-first") -> tuple[str, str]:
...
def render_menu(ex: MenuExample, names: dict[int, str], layout: str = "menu-first") -> str:
